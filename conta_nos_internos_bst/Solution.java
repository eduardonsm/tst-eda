...
public class Solution{
        public static void main(String[] args){
                ...
                contaNosInternos(bst);

        }
        public static void contaNosInternos(BST bst){
...
class BST {
    ...
    */
    ...
    public int contaNosInternos() {
        if (this.root == null )return 0;
        else return reccontaNosInternos(this.root);
    }
    private int reccontaNosInternos(Node aux){
        if(aux.left==null && aux.right==null) return 0;
        if (aux.left == null) return 1+reccontaNosInternos(aux.right);
        if (aux.right == null) return 1+reccontaNosInternos(aux.left);
        return 1+reccontaNosInternos(aux.right)+reccontaNosInternos(aux.left);	    
    }
